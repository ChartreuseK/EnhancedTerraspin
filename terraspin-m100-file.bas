...
532 IF C$ = "," OR C$=CHR$(10) OR C$=CHR$(13) THEN IP = IP + 1:GOTO 520
535 REM (single step dbg) PRINT "IP:";IP;"C$";C$;" SP:";SP;"STK:";SK(SP):INPUT$(1)
540 IF C$ >= "-" AND C$ <= "9" THEN GOSUB 1210:GOTO 530
550 IF C$ = "(" THEN V = IP:GOSUB 1010
560 IF C$ = ")" THEN GOSUB 2010:GOTO 520
...
635 IF C$ = "R" THEN GOSUB 8010:GOTO 520
640	IF C$ = "K" THEN GOSUB 1110
645 IF C$ = "C" THEN GOSUB 8510:GOTO 520
650 IF C$ = "X" THEN GOSUB 9010
655 IF C$ = "Q" THEN GOSUB 9510
700 IP = IP + 1
710 IF EOF(1) THEN CLOSE 1:GOTO 710
720 GOTO 520
